/* RSSLParser.java */
/* Generated By:JavaCC: Do not edit this line. RSSLParser.java */
...
public class RSSLParser implements RSSLParserConstants {
...
dec.where = new CodePlace(cp0); tmp3 = new VarDec(); tmp3.constant = true;
        tmp0 = type();
tmp3.type = tmp0;
        tmp1 = id();
tmp3.name = tmp1;
...
flag0 = true;
    ...
    def0 = func_declr();
def = new NativeFuncDef(def0, flag0); def.where = new CodePlace(cp0); {if ("" != null) return def;}
    throw new Error("Missing return statement in function");
  }
...
def.params = tmp1;
    ...
    if (jj_2_15(4)) {
      jj_consume_token(NOTHING);
def.returns = new ReturnType(Type.nullType);
    } else if (jj_2_16(4)) {
      tmp2 = type();
def.returns = new ReturnType(tmp2);
      if (jj_2_14(4)) {
        jj_consume_token(42);
...
place = new CodePlace(cp0);
      tmp0 = var_declr();
tmp0.where = place; list.add(tmp0);
    }
{if ("" != null) return list;}
    throw new Error("Missing return statement in function");
  }
...
setStmt = new SetStatement(); setStmt.where = new CodePlace(cp0);
      tmp0 = id();
setStmt.id = tmp0;
      jj_consume_token(41);
      tmp1 = expr();
setStmt.val = tmp1; {if ("" != null) return setStmt;}
      ...
      cp0 = jj_consume_token(SET);
setArrStmt = new SetArrayStatement(); setArrStmt.where = new CodePlace(cp0);
      tmp0 = id();
setArrStmt.id = tmp0;
      jj_consume_token(44);
      tmp1 = expr();
...
stmt = new CallStatement(); stmt.where = new CodePlace(cp0);
    tmp0 = id();
stmt.id = tmp0;
    jj_consume_token(46);
    if (jj_2_35(4)) {
...
/* A RAISE statement */
  final public Statement raise() throws ParseException {RaiseStatement stmt;
        Expression tmp0;
        Token cp0;
    cp0 = jj_consume_token(RAISE);
stmt = new RaiseStatement(); stmt.where = new CodePlace(cp0);
    tmp0 = expr();
stmt.expression = tmp0; {if ("" != null) return stmt;}
    throw new Error("Missing return statement in function");
  }
...
stmt = new ConditionalStatement(StatementType.IF); stmt.where = new CodePlace(cp0);
    tmp0 = expr();
...
nest.type = StatementType.ELSE; nest.where = new CodePlace(cp0);
      tmp1 = statement_list();
nest.statements = tmp1; {if ("" != null) return nest;}
    } else if (jj_2_40(4)) {
      cp0 = jj_consume_token(ELSEIF);
nest.type = StatementType.ELSEIF; nest.where = new CodePlace(cp0);
      tmp0 = expr();
...
stmt = new LoopStatement(); stmt.where = new CodePlace(cp0);
    tmp0 = statement_list();
...
/* A TRY statement */
  final public Statement trycatch() throws ParseException {TryCatchStatement stmt;
        StatementList tmp0, tmp1;
        Token cp0, cp1;
    cp0 = jj_consume_token(TRY);
stmt = new TryCatchStatement(); stmt.where = new CodePlace(cp0);
    tmp0 = statement_list();
stmt.statements = tmp0;
    cp1 = jj_consume_token(CATCH);
stmt.whereCatch = new CodePlace(cp1);
    tmp1 = statement_list();
stmt.catchStatements = tmp1;
...
stmt = new LoopExitStatement(); stmt.where = new CodePlace(cp0);
    tmp0 = expr();
...
stmt = new ReturnStatement(); stmt.where = new CodePlace(cp0);
    if (jj_2_41(4)) {
      tmp0 = expr();
...
rt.debug = true; rt.debugWhere = new CodePlace(cp0);  {if ("" != null) return rt;}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return Identifier.fromToken(identoken, new CodePlace(token));}
  ...
  private boolean jj_3R_20()
 {
    ...
    if (jj_3R_28()) return true;
    if (jj_scan_token(ENDTRY)) return true;
    return false;
  }
  ...
  private boolean jj_3_37()
 {
  ...
  public RSSLParserTokenManager token_source;
  ...
  public RSSLParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public RSSLParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new RSSLParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public RSSLParser(java.io.Reader stream) {
  ...
  public RSSLParser(RSSLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(RSSLParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
