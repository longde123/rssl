...
import net.allochie.vm.rssl.ast.constant.IntConstType;
...
import net.allochie.vm.rssl.ast.expression.BinaryOp;
...
import net.allochie.vm.rssl.ast.expression.UnaryOp;
...
import net.allochie.vm.rssl.ast.statement.StatementType;
...
public class RSSLParser implements RSSLParserConstants {
	 ...
	 * func entries.
	 */
	final public RSSLFile file() throws ParseException {
	...
	/* A RAISE statement */
	final public Statement raise() throws ParseException {
		RaiseStatement stmt;
		Expression tmp0;
		Token cp0;
		cp0 = jj_consume_token(RAISE);
		stmt = new RaiseStatement();
		stmt.where = new CodePlace(cp0);
		tmp0 = expr();
	...
	/* A TRY statement */
	final public Statement trycatch() throws ParseException {
		TryCatchStatement stmt;
		StatementList tmp0, tmp1;
		Token cp0, cp1;
		cp0 = jj_consume_token(TRY);
		stmt = new TryCatchStatement();
		stmt.where = new CodePlace(cp0);
		tmp0 = statement_list();
		stmt.statements = tmp0;
	...
	static private final class LookaheadSuccess extends java.lang.Error {
		 ...
		 *
		 */
		private static final long serialVersionUID = -1362135187314511201L;
	}
