...
public class JASSParser implements JASSParserConstants {
	...
	final public Expression simple_expr() throws ParseException {
		...
		if (jj_2_44(4)) {
			...
			{
				if ("" != null)
					return new IdentifierReference(tmp0);
			}
		} else if (jj_2_50(4)) {
			exp = constval();
			{
	...
	final public IntConst decimal() throws ParseException {
		...
		{
			if ("" != null)
				return IntConst.fromToken(inttoken, IntConstType.DECIMAL);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public IntConst octal() throws ParseException {
		...
		{
			if ("" != null)
				return IntConst.fromToken(inttoken, IntConstType.OCTAL);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public IntConst hex() throws ParseException {
		...
		{
			if ("" != null)
				return IntConst.fromToken(inttoken, IntConstType.HEXADECIMAL);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public IntConst fourcc() throws ParseException {
		...
		{
			if ("" != null)
				return IntConst.fromToken(inttoken, IntConstType.FOURCC);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public RealConst real_const() throws ParseException {
		...
		{
			if ("" != null)
				return RealConst.fromToken(realtoken);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public StringConst string_const() throws ParseException {
		...
		{
			if ("" != null)
				return StringConst.fromToken(stringtoken);
		}
		throw new Error("Missing return statement in function");
	}
	...
	final public Type type() throws ParseException {
		...
		if (jj_2_78(4)) {
			...
			{
				if ("" != null)
					return Type.fromIdentifier(tmp0);
			}
		} else if (jj_2_79(4)) {
			jj_consume_token(65);
			{
	...
	final public Identifier id() throws ParseException {
		...
		{
			if ("" != null)
				return Identifier.fromToken(identoken);
		}
		throw new Error("Missing return statement in function");
	}
